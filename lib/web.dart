...
class RecipeView2 extends StatefulWidget {
  String postUrl;
...
class _RecipeViewState extends State<RecipeView2> {
  int index = 0;
  ...
  String finalUrl;
  String url2 =
      "https://www.healthline.com/nutrition/11-ways-to-eat-clean#TOC_TITLE_HDR_2";
